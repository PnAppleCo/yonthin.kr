...
<div style="background: #f1f1f1;">
	<div class="tit1">
		<strong>미디어자료실</strong>
	</div>
	<div class="board">
		<div class="board_tab">
		<a href="<?=$_SERVER["PHP_SELF"];?>?code=4_5_1" class="">문서자료실</a>
		<a href="<?=$_SERVER["PHP_SELF"];?>?code=4_5_2" class="on">미디어자료실</a>
		</div>
			...
			<ul>
				...
				for($i = $first; $i <= $last; $i++) {
					...
					if($view[$i][idx]>558) {
						...
						if(file_exists($_SERVER["DOCUMENT_ROOT"]."/data/file/photo/thumb/".$view[$i][etc01])) {
							$thumbneil_img = "/data/file/photo/thumb/".$view[$i][etc01];
						}
					}
					if($view[$i][youtube]) $thumbneil_img = "https://img.youtube.com/vi/".$view[$i][youtube]."/mqdefault.jpg";
				...
				<li>
					<a href="<?=$link;?>">
						<img src="<?=$thumbneil_img;?>" style="height:300px:" />
						<p><?=$subject;?></p>
