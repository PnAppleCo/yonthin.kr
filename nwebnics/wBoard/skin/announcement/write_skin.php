		...
		<form name="signForm" id="signForm" ENCTYPE="multipart/form-data">
			<fieldset>
				...
				<div id="formWrap">
					<dl class="formDl">
						<dt>글 제 목</dt>
						<dd><input type="text" name="subject" size="55" maxlength="100" class="textbox textBoxclass" value="<? if(!strcmp($now_path, "reple.php") || !strcmp($now_path, "edit.php")) echo $view[subject];?>" placeholder="공고 제목 입력(필수)" title="공고 제목입력" /></dd>
					</dl>
					<dl class="formDl">
						<dt>담당자</dt>
						<dd><input type="text" name="name" size="15" maxlength="12" class="textbox textBoxclass" value="<?if(!strcmp($now_path, "edit.php")) echo $view[name]; else echo $_SESSION[my_name];?>" title="담당자 입력" placeholder="담당자 입력(필수)" /></dd>
					</dl>
					<dl class="formDl">
						<dt>담당부서</dt>
						<dd><input type="text" name="etc03" size="15" maxlength="50" class="textbox textBoxclass" value="<?if(!strcmp($now_path, "edit.php")) echo $view[etc03];?>" title="담당부서 입력" placeholder="담당부서 입력" /></dd>
					</dl>
					<?if(strcmp($now_path, "edit.php")) {?>
					<dl class="formDl">
						<dt>비밀번호</dt>
					...
					<dl class="formDl">
						...
						?>
						<input type="text" name="etc01" id="etc01" size="15" maxlength="20" class="textbox textBoxclass" value="<? if(!strcmp($now_path, "reple.php") || !strcmp($now_path, "edit.php")) echo $view[etc01];?>" placeholder="공고시작일 선택" title="공고시작일 선택" readonly />~<input type="text" name="etc02" id="etc02" size="15" maxlength="20" class="textbox textBoxclass" value="<? if(!strcmp($now_path, "reple.php") || !strcmp($now_path, "edit.php")) echo $view[etc02];?>" placeholder="공고종료일 선택" title="공고종료일 선택" readonly /></dd>
					</dl>
					<?if(member_session(1)) {?>
					<dl class="formDl">
						<dt>입력시간</dt>
					...
					<dl class="formDl">
						<dt>검색태그</dt>
						<dd><input type="text" name="keytag" size="40" maxlength="255" class="textbox" value="<?=$view[keytag];?>" title="검색 태그 입력" /> ※ 다수 입력시 ','(쉼표)로 분리</dd>
					</dl>
					...
					<div class="clear_both">
						<textarea name="svc_reply" rows="5" class="textarea" placeholder="답변내용 입력"><?=$view[svc_reply];?></textarea>
					</div>
					<?}?>
				</div>
			<fieldset>
