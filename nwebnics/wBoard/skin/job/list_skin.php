...
if($rst_print) $rst_print="<tr><td colspan=\"6\">".$rst_print."</td></tr>";
		...
		<table summary="게시판 목록">
			...
			<tbody>
				...
				for($i = $first; $i <= $last; $i++) {
					...
					if($_GET[code]=='6_6_1') {
						$diviTitle="구인";
						if(strtotime($view[$i][etc01]) >= strtotime(date('Y-m-d'))) $recruitStatus="<span class=\"statusBtn04\">모집중</span>"; else $recruitStatus="<span class=\"statusBtn03\">모집종료</span>";
					}
				?>
					<tr>
						<td><?=$article_num;?>.</td>
						...
						<td><?=$real_email;?></td>
						<td><?=$signdate;?></td>
						<?if($_GET[code]=='6_6_1') echo "<td>".$recruitStatus."</td>"; else echo "<td>".$view[$i][click]."</td>";?>
					</tr>
				<?
				$rTitle = "";//== 제목변수 초기화
				$article_num--; }
