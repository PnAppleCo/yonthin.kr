		...
		<form name="signForm" id="signForm" ENCTYPE="multipart/form-data">
			<fieldset>
				...
				<div id="formWrap">
							...
							<?
								...
								if($board_info[board_class]) {
									...
									for($i=0; $i<count($class_item); $i++) {
										...
										$p_class .= "<input type=\"radio\" name=\"b_class\" value=\"".$class_item[$i]."\"".$class_selected." class=\"align_left_middle\" />".$class_item[$i]." ";
									}
									echo $p_class;
								}
							?>
					...
					<dl class="formDl">
						<dt>상담제목</dt>
						<dd><input type="text" name="subject" size="50" maxlength="100" class="textbox textBoxclass" value="<? if(!strcmp($now_path, "reple.php") || !strcmp($now_path, "edit.php")) echo $view[subject];?>" placeholder="글제목입력(필수)" title="글제목입력" /></dd>
					</dl>
					<dl class="formDl">
						<dt>작 성 자</dt>
