...
class Thumbnail
{
	...
	public static function create($filepath, $width = null, $height = null, $scale = 'exactfit', $options = null)
	{
		...
		*/
		...
		switch ($type[2])
		{
			case 1: if (!imagegif($thumbnail, $savepath)) $iserror = true; break;
			case 2: if (!imagejpeg($thumbnail, $savepath)) $iserror = true; break;
			case 3: if (!imagepng($thumbnail, $savepath)) $iserror = true; break;
		}
