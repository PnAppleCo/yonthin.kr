											...
											<table summary="회원 정보입력">
												...
												<tbody>
													<tr>
														...
														<td colspan="3"><input type="text" name="id" size="15" maxlength="20"<?if($view[id]) echo " value=\"$view[id]\"";?> class="textbox" title="아이디입력"> <a href="javascript:dupl_id_check(1)" title="아이디 중복확인"><img src="./img/id_check(btn).gif" align="absmiddle" alt="중복확인"></a> ※ 5~20자 이하 영,숫자 조합(특수문자 "-", "_"만 허용)</td>
													</tr>
													<tr>
														<th><label for="name">성&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;명</label><span style="color:red; vertical-align:bottom;"><strong>*</strong></span></th>
														<td><input type="text" name="name" size="15" maxlength="16"<?if($view[name]) echo " value=\"$view[name]\"";?> class="textbox" title="성명입력"></td>
														<th><label for="nickname">별&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;명</label></th>
														<td><input type="text" name="nickname" size="15" maxlength="16"<?if($view[nickname]) echo " value=\"$view[nickname]\"";?> class="textbox" title="별명입력"></td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td colspan="3">
															...
															<input type="text" name="iAnswer" size="25" maxlength="255"<?if($view[iAnswer]) echo " value=\"$view[iAnswer]\"";?> class="textbox" title="답변 입력"><br />
													...
													<tr>
														...
														<td colspan="3">
															...
															<input type="radio" name="solu" value="1"<?if($view[solu]==1 || $_GET[mode]==="add") echo " checked";?> class="align_right_middle">양&nbsp;<input type="radio" name="solu" value="2"<?if($view[solu]==2) echo " checked";?> class="align_right_middle">음
														</td>
													</tr>
													<tr>
														<th><label for="email_a">전자우편</label><span style="color:red; vertical-align:bottom;"><strong>*</strong></span></th>
														<td colspan="3">
															<input name="email_a" size="15" maxlength="25"<?if($arrEmail[0]) echo " value=\"$arrEmail[0]\"";?> class="textbox" title="메일 아이디 입력">&nbsp;@
															<input name="email_b" size="15" maxlength="25"<?if($arrEmail[1]) echo " value=\"$arrEmail[1]\"";?> class="textbox" title="메일도메인 입력">
															...
															</select>메일수신<input type="checkbox" name="news_dm" value="1" <?if($view[news_dm]==1) echo " checked";?> title="메인수신여부" class="align_right_middle">
														</td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td>
															...
															</select>-<input type="text" name="tel_2" size="5" maxlength="4"<?if($arrTel[1]) echo " value=\"$arrTel[1]\"";?> class="textbox" title="일반전화 가운데자리 입력">-<input type="text" name="tel_3" size="5" maxlength="4"<?if($arrTel[2]) echo " value=\"$arrTel[2]\"";?> class="textbox" title="일반전화 끝자리 입력">
														</td>
														...
														<td width="" class="line_solid">
															...
															</select>-<input type="text" name="sel_2" size="5" maxlength="4"<?if($arrSel[1]) echo " value=\"$arrSel[1]\"";?> class="textbox" title="휴대전화 가운데 자리 입력">-<input type="text" name="sel_3" size="5" maxlength="4"<?if($arrSel[2]) echo " value=\"$arrSel[2]\"";?> class="textbox" title="휴대전화 끝 자리 입력">
														</td>
													</tr>
													<tr>
													...
													<?}?>
													<?if($siteType==2) include ("./inc/shopDetails_inc.php");?>
											</table>
									</fieldset>
								</form>
							</div>
