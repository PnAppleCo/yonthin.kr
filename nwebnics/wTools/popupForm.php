										...
										<table summary="팝업 정보 등록 및 수정 테이블">
											...
											<tbody>
												...
												<tr>
													<th>팝업종류</th>
													<td>
														<input type="radio" name="popupType" value="1"<?if($view[popupType]==1) echo " checked";?> class="align_left_middle" />새창
														<input type="radio" name="popupType" value="2"<?if($view[popupType]==2) echo " checked";?> class="align_left_middle" />레이어
														<input type="radio" name="popupType" value="3"<?if($view[popupType]==3) echo " checked";?> class="align_left_middle" />슬라이드
													</td>
												</tr>
												<tr>
													<th>팝업옵션</th>
													<td>
														<input type="checkbox" name="ingTime" value="1"<?if($view[ingTime]==1) echo " checked";?> class="align_left_middle" />1일제한
														<input type="checkbox" name="scrollbar" value="1"<?if($view[scrollbar]==1) echo " checked";?> class="align_left_middle" />스크롤바
													</td>
												</tr>
												<tr>
													<th>시작/종료</th>
												...
												<tr>
													...
													<td>
														...
														<select name="linkTarget" class="wSbox">
															<option value="1"<?if($view[linkTarget]==1) echo " selected";?>>자체</option>
															<option value="2"<?if($view[linkTarget]==2) echo " selected";?>>새창</option>
															<option value="3"<?if($view[linkTarget]==3) echo " selected";?>>부모</option>
														</select>
