												...
												<table summary="게시판 등록.">
													...
													<tbody>
														<tr>
															...
															<td><input type="text" name="code" size="12" maxlength="12" value="<?=$board_info[code];?>" class="wTbox" <?if($_GET[mode]==="edit") echo" readonly";?> title="게시판코드"></td>
															<th>스킨설정</th>
															<td>
														...
														<tr>
															<th>성인전용</th>
															<td><input type="checkbox" name="adult" value="1"<?if($board_info[adult]==1) echo " checked";?>></td>
															<th>리플제거</th>
															<td><input type="checkbox" name="noreplebtn" value="1"<?if($board_info[noreplebtn]==1) echo " checked";?>></td>
														</tr>
														<tr>
															<th>답변글 삭제 제한</th>
															<td><input type="checkbox" name="allow_delete_thread" value="1"<?if($board_info[allow_delete_thread]==1) echo " checked";?>></td>
															<th>미리보기설정</th>
															<td><input type="checkbox" name="overview" value="1"<?if($board_info[overview]==1) echo " checked";?>></td>
														</tr>
														<tr>
															<th>선택읽기 선택</th>
															<td><input type="checkbox" name="twinread" value="1"<?if($board_info[twinread]==1) echo " checked";?>></td>
															<th>게시물 승인형</th>
															<td><input type="checkbox" name="approve" value="1"<?if($board_info[approve]==1) echo " checked";?>></td>
														</tr>
														<tr>
															<th>목록파일보기</th>
															<td><input type="checkbox" name="pds_view" value="1"<?if($board_info[pds_view]==1) echo " checked";?>></td>
															<th>이미지만 업로드</th>
															<td><input type="checkbox" name="only_img" value="1"<?if($board_info[only_img]==1) echo " checked";?>></td>
														</tr>
														<tr>
															<th>쎔네일(넓이)</th>
														...
														<tr>
															...
															<td>
																<select name="relation_text" class="wSbox">
																	<option value=""<?if($board_info[relation_text] == 0) echo " selected";?>>관련글 없음</option>
																	<option value="1"<?if($board_info[relation_text] == 1) echo " selected";?>>이전/이후글</option>
																	<option value="2"<?if($board_info[relation_text] == 2) echo " selected";?>>전체게시물</option>
																	<option value="3"<?if($board_info[relation_text] == 3) echo " selected";?>>관련 리플</option>
																</select>
															</td>
															<th>코멘트 사용</th>
															<td><input type="checkbox" name="write_comment" value="1"<?if($board_info[write_comment]==1) echo " checked";?>></td>
														</tr>
														<tr>
															<th>코멘트 글자수제한</th>
														...
														<tr>
															<th>글작성시 쿠키설정</th>
															<td><input type="checkbox" name="set_cookie_data" value="1"<?if($board_info[set_cookie_data]==1) echo " checked";?>></td>
															<th>글추천기능</th>
															<td><input type="checkbox" name="recommend" value="1"<?if($board_info[recommend]==1) echo " checked";?>></td>
														</tr>
														<tr>
															<th>로그인방법</th>
															<td>
																<select name="log_info" class="wSbox">
																	<option value="1"<?if($board_info[log_info] == 1) echo " selected";?>>세션</option>
																	<option value="2"<?if($board_info[log_info] == 2) echo " selected";?>>쿠키</option>
																	<option value="3"<?if($board_info[log_info] == 3) echo " selected";?>>기타</option>
																</select>
															</td>
															<th>제목줄임</th>
														...
														<tr>
															...
															<td colspan="3">
																<select name="alignField" class="wSbox">
																	<option value="1"<?if($board_info[alignField] == 1) echo " selected";?>>순서</option>
																	<option value="2"<?if($board_info[alignField] == 2) echo " selected";?>>날짜</option>
																</select>
															</td>
														</tr>
														<tr>
															<th>베스트글 추출</th>
															<td><input type="checkbox" name="best_img" value="1"<?if($board_info[best_img]>0) echo " checked";?>></td>
															<th>Html Editor</th>
															<td>
																<select name="html_editor" class="wSbox">
																	<option value="0"<?if($board_info[html_editor] == 0) echo " selected";?>>Default</option>
																	<option value="1"<?if($board_info[html_editor] == 1) echo " selected";?>>fckeditor1</option>
																	<option value="2"<?if($board_info[html_editor] == 2) echo " selected";?>>fckeditor2</option>
																	<option value="3"<?if($board_info[html_editor] == 3) echo " selected";?>>fckeditor3</option>
																	<option value="4"<?if($board_info[html_editor] == 4) echo " selected";?>>daumeditor</option>
																	<option value="5"<?if($board_info[html_editor] == 5) echo " selected";?>>fckeditor4</option>
																	<option value="6"<?if($board_info[html_editor] == 6) echo " selected";?>>ckeditor</option>
																	<option value="7"<?if($board_info[html_editor] == 7) echo " selected";?>>smarteditor</option>
																</select>
															</td>
														</tr>
														<tr>
															<th>민원처리</th>
															<td><input type="checkbox" name="ps_center" value="1"<?if($board_info[ps_center]>0) echo " checked";?>></td>
															<th>실명인증</th>
															<td><input type="checkbox" name="real_name" value="1"<?if($board_info[real_name]>0) echo " checked";?>></td>
														</tr>
														<tr>
															<th>일반상단호출</th>
