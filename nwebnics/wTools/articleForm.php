										...
										<table summary="게시물 정보 관리">
											...
											<tbody>
												<tr>
													...
													<td style="text-align:left; font-weight:600">
														...
														<select name="b_class" id="cateB" class="wSbox">
															<option value="">선택하세요</option>
															<?if($view[b_class]) echo "<option value=\"".$view[b_class]."\" selected>".$view[b_class]."</option>";?>
														</select>
													</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td style="text-align:left;">
														<input type="text" name="name" id="name" size="20" class="wTbox" maxlength="50" value="<?if(!$view[name]) echo "청년독립지원청"; else echo $view[name];?>" placeholder="작성자명 입력" title="작성자명 입력" />
													</td>
												</tr>
												<!-- <tr>
