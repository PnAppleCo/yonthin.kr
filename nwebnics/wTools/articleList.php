									...
									<form name="searchForm" method="get" action="<?=$_SERVER['PHP_SELF'];?>" class="cf">
										<fieldset class="searchFrm cf">
											...
											<select name="gField" class="radiusS">
												<option value="subject"<?php if($_GET['gField']=='subject') echo " selected";?>>제목</option>
												<option value="ucontents"<?php if($_GET['gField']=='ucontents') echo " selected";?>>내용</option>
												<option value="name"<?php if($_GET['gField']=='name') echo " selected";?>>작성자</option>
											</select>
